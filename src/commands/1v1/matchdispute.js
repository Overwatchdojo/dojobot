...
const name = '1v1matchdispute';

class MatchDisputeCommand extends Command {
  constructor() {
    super(name, {
      aliases: [ name ],
      category: '1v1',
  ...
  async exec(message, { matchId }) {
    ...
    match.matchState = MatchStates.DISPUTED;
    await match.save();

    return message.author.send('Match is disputed. Please wait until the Overwatchdojo team manually resolves it.');
  }
}

MatchDisputeCommand.commandName = name;

module.exports = MatchDisputeCommand;
